...
(function ($) {
  'use strict';
  // next/script can execute after the browser's load/DOMContentLoaded events.
  // Preserve the original deferred-script behavior by running callbacks
  // immediately when their event has already happened.

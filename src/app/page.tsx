...
export default function Page() {
  return (
    ...
    <section id="home" class="wpr-banner-area">
        <div class="container">
            <div class="banner-content-area">
                ...
                <h1 class="section-title">
                    ...
                    <span class="arrow-track right">
                            <span class="arrow"><img src="/assets/images/banner/icon/arrow-right.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-right.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-right.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-right.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-right.svg" alt=""></span>
                    ...
                    <span class="mid-icon wow scaleIn" data-wow-delay=".7s">
                        <span class="inner">
                            <img src="/assets/images/banner/hero-logo.png" width="303" alt="hero logo" class="pendulum-animation">
                        </span>
                    </span>
                    <span class="right-area square-dot wow fadeInRight" data-wow-delay=".7s">
                        <span class="arrow-track right">
                            <span class="arrow"><img src="/assets/images/banner/icon/arrow-left.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-left.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-left.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-left.svg" alt=""></span>
                    <span class="arrow"><img src="/assets/images/banner/icon/arrow-left.svg" alt=""></span>
                ...
                <div class="banner-shape-area">
                    <img src="/assets/images/banner/shape/shape-01.svg" alt="" class="one wow fadeInLeft" data-wow-delay=".2s">
                    <img src="/assets/images/banner/shape/shape-02.svg" alt="" class="two wow fadeInRight" data-wow-delay=".2s">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-wrapper wow fadeInRight" data-wow-delay=".6s">
                        ...
                        <div class="content">
                            <div class="top">
                                ...
                                <p class="desc">We craft distinctive visual identities and design systems that deeply
                    ...
                    <div class="service-wrapper wow fadeInRight" data-wow-delay=".8s">
                        ...
                        <div class="content">
                            <div class="top">
                                ...
                                <p class="desc">We develop robust, scalable eCommerce platforms designed to maximize
                                    conversions and drive sales growth.</p>
                            </div>
                            <div class="mid">
                                <h2>04</h2>
                            </div>
                ...
                <div class="floating-content">
                    <div class="section-title-area center-style">
                        ...
                        <h2 class="section-title second-font font-semi-bold text-normal">Every project we take on <br>
                            <span>starts <span><img src="/assets/images/portfolio/sm.webp" width="147" alt=""></span>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="slide feature-project">
                                        <div class="image-area">
                                            <img src="/assets/images/portfolio/01.webp" alt="" class="video-img">
                                            <img src="/assets/images/portfolio/shape-top-left.svg" alt="" class="shape top-left-shape">
                                            <img src="/assets/images/portfolio/shape-top-right.svg" alt="" class="shape top-right-shape">
                                        </div>
                                        <div class="slide-content">
                                            <div class="product-intro">
                                                <div class="top">
                                                    <h2 class="h3 title"><a href="/works/details">Nova Mobile App</a>
                                                    </h2>
                                        ...
                                        <div class="hover_mouse">
                                            <div class="box"></div>
                                            <a href="/works/details">
                                                View Projects
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18 0V13.4751H16.5083V2.53591L1.0442 18L0 16.9061L15.4144 1.49171H4.47514V0H18Z" fill="#005D74" />
                                                </svg>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="slide feature-project">
                                        <div class="image-area">
                                            <img src="/assets/images/portfolio/02.webp" alt="" class="video-img">
                                            <img src="/assets/images/portfolio/shape-top-left.svg" alt="" class="shape top-left-shape">
                                            <img src="/assets/images/portfolio/shape-top-right.svg" alt="" class="shape top-right-shape">
                                        </div>
                                        <div class="slide-content">
                                            <div class="product-intro">
                                                <div class="top">
                                                    <h3 class="title"><a href="/works/details">Axis Legal Website</a>
                                                    </h3>
                                                    <p class="desc">We streamlined user flows, refreshed the visual
                                                        language, and introduced accessibility-focused design components
                                                        to improve usability.</p>
                                ...
                                <div class="swiper-slide">
                                    <div class="slide feature-project">
                                        <div class="image-area">
                                            <img src="/assets/images/portfolio/03.webp" alt="" class="video-img">
                                            <img src="/assets/images/portfolio/shape-top-left.svg" alt="" class="shape top-left-shape">
                                            <img src="/assets/images/portfolio/shape-top-right.svg" alt="" class="shape top-right-shape">
                                        </div>
                                        <div class="slide-content">
                                            <div class="product-intro">
                                                <div class="top">
                                                    <h3 class="title"><a href="/works/details">Lunaris Co .
                                                            Branding</a></h3>
            ...
            <div class="section-inner overflow-hidden border-1">
                <div class="text-wrapper first-text">
                    <div class="text-split scrollingtext-1">
                        <h2 class="title">
                            Innovative <span><img src="/assets/images/icon/black-right.svg" alt=""></span>
                            Innovative <span><img src="/assets/images/icon/black-right.svg" alt=""></span>
                            Innovative <span><img src="/assets/images/icon/black-right.svg" alt=""></span>
                            Innovative <span><img src="/assets/images/icon/black-right.svg" alt=""></span>
                            Innovative <span><img src="/assets/images/icon/black-right.svg" alt=""></span>
                ...
                <div class="text-wrapper">
                    <div class="text-split scrollingtext-2">
                        <h2 class="title">
                            Visionary <span><img src="/assets/images/icon/black-left.svg" alt=""></span>
                            Visionary <span><img src="/assets/images/icon/black-left.svg" alt=""></span>
                            Visionary <span><img src="/assets/images/icon/black-left.svg" alt=""></span>
                            Visionary <span><img src="/assets/images/icon/black-left.svg" alt=""></span>
                            Visionary <span><img src="/assets/images/icon/black-left.svg" alt=""></span>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="why-choose-wrapper ml-auto">
                                            ...
                                            <ul class="wrapper-list">
                                                <li>
                                                    <img src="/assets/images/why-choose/check-01.svg" alt="">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="why-choose-wrapper">
                                            ...
                                            <ul class="wrapper-list two">
                                                <li>
                                                    <img src="/assets/images/why-choose/check-02.svg" alt="">
    ...
    <section class="wpr-testimonials-area mb--16">
        <div class="container">
            <div class="section-inner border-1" style="padding: 80px 20px; text-align: center;">
                <!-- Elfsight Google Reviews | Untitled Google Reviews -->
                <script src="https://elfsightcdn.com/platform.js" async></script>
                <div class="elfsight-app-f391997e-e084-4ef3-bb4a-698260a76d86" data-elfsight-app-lazy></div>
            </div>
        </div>
    </section>
                ...
                <div class="section-content-area">
                    ...
                    <div class="accordion-one" id="accordionExample2">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse show" role="region" aria-labelledby="headingSix" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">We do four things: apps, video, design, and online stores. We can help with the whole project or just one part.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingSeven">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                    Do you work with new businesses or big ones?
                                </button>
                            </h2>
                            <div id="collapseSeven" class="accordion-collapse collapse" role="region" aria-labelledby="headingSeven" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">Both! We help new startups and big brands too.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" role="region" aria-labelledby="headingEight" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">It depends. A logo project can take 2–4 weeks. An app or online store can take 2–3 months. We'll tell you the timeline after we talk.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingNine">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                    Can I get help with just one thing, like video or branding?
                                </button>
                            </h2>
                            <div id="collapseNine" class="accordion-collapse collapse" role="region" aria-labelledby="headingNine" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">Yes! You don't need all our services. We can make your video, or just your logo, or just your app.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTen" class="accordion-collapse collapse" role="region" aria-labelledby="headingTen" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">Go to our contact section and tell us about your project. Then we'll set up a call.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingEleven">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                    Do you help after the project is done?
                                </button>
                            </h2>
                            <div id="collapseEleven" class="accordion-collapse collapse" role="region" aria-labelledby="headingEleven" data-bs-parent="#accordionExample2">
                                <div class="accordion-body">
                                    <p class="desc">Yes! We help fix problems and keep your app or store working well after it launches.</p>
                                </div>
                            </div>
                        </div>

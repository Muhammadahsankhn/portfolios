            ...
            <div class="header-style-one-wrapper">
                ...
                <nav class="main-nav-area">
                    <ul class="list-unstyled wpr-desktop-menu">
                        ...
                        <li class="menu-item has-dropdown">
                            <a class="main-element wpr-dropdown-main-element active" href="/works">BLOG</a>
                            <ul class="sub-menu">
                                <li class="sub-menu-item">
                        ...
                        <li class="menu-item active"><a class="main-element wpr-dropdown-main-element" href="/contact">CONTACT</a></li>
                    </ul>
                </nav>
    ...
    <section class="wpr-banner-area breadcrumb">
        <div class="container">
            <div class="banner-content-area">
                ...
                <p class="desc">Reach out to our team today and let’s collaborate to turn your ideas <br> into
                    innovative solutions that truly inspire</p>
                <div class="bg-shape">
                ...
                <div class="row g-5 mb--60">
                    <div class="col-lg-4 col-md-6 col-sm-6 md-mb-24">
                        <div class="box-contact-item text-center effectFade fadeUp">
                            ...
                            <a class="text" href="mail:hello@youraiagency.com">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 md-mb-24">
                        <div class="box-contact-item text-center effectFade fadeUp" data-delay="0.1">
                            ...
                            <a href="tel:+1(647)5550172" class="text">
                                +1 (647) 555 0172
                            </a>
                        </div>
                    </div>

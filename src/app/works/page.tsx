        ...
        <div class="container">
            <div class="banner-content-area">
                <h1 class="section-title text-normal wow scaleIn" data-wow-delay=".7s">
                    Our Work In Action <br> Featured Work
                </h1>
                <p class="desc">We transform concepts into purposeful digital solutions through strategic thinking and
                    design. <br>
                    Each project balances creativity and technology to deliver lasting value. </p>
                <div class="bg-shape">
            ...
            <div class="section-inner border-1">
                <div class="section-top-area">
                    <div class="section-title-area center-style">
                        <p class="sub-title">OUR VISION</p>
                        <h2 class="section-title second-font font-semi-bold text-normal wpr-text-anime-style-1"> Recent
                            Works
                        </h2>
                    </div>
                </div>
                <div class="project-slider-inner">
                    <div class="project-wrapper2">
                        <div class="image-area">
                            <a href="/works/details" class="over-link"></a>
                            <img src="/assets/images/portfolio/01.webp" alt="" class="video-img">
                            <img src="/assets/images/portfolio/shape-top-left-w.svg" alt="" class="shape top-left-shape">
                            <img src="/assets/images/portfolio/shape-top-right-w.svg" width="120" alt="" class="shape top-right-shape">
                        </div>
                        <div class="slide-content">
                            <div class="product-intro">
                                <div class="top">
                                    <h3 class="title"><a href="/works/details">Nova Mobile App</a>
                                    </h3>
                        ...
                        <div class="slide-content">
                            <div class="product-intro">
                                <div class="top">
                                    ...
                                    <p class="desc">We created a refined visual identity and a sleek new
                                        website that communicates trust, clarity, and confidence.</p>
                                </div>
                                <div class="bottom">
                                    <ul>
                                        <li>
                            ...
                            <div class="product-intro">
                                <div class="top">
                                    ...
                                    <p class="desc">We crafted a modern visual identity for Lunaris
                                        Coffee
                                        Co., blending organic textures with clean typography to reflect
                                        their artisanal roots.</p>
                                </div>
                                <div class="bottom">
                                    <ul>
                                        <li>
                    ...
                    <div class="project-wrapper2">
                        <div class="image-area">
                            <a href="/works/details" class="over-link"></a>
                            <img src="/assets/images/portfolio/08.webp" alt="" class="video-img">
                            <img src="/assets/images/portfolio/shape-top-left-w.svg" alt="" class="shape top-left-shape">
                            <img src="/assets/images/portfolio/shape-top-right-w.svg" width="120" alt="" class="shape top-right-shape">
                        </div>
                        <div class="slide-content">
                            <div class="product-intro">
                                <div class="top">
                                    <h3 class="title"><a href="/works/details">EcomPro Store Design</a></h3>
                                    <p class="desc">Redesigned an eCommerce platform with conversion-focused UX,
                                        resulting in higher sales and smoother checkout flow.</p>
                                </div>
                                <div class="bottom">
                                    <ul>
                                        <li>
                            ...
                            <div class="button-area">
                                <div class="box"></div>
                                <a href="/works/details">VIEW PROJECTS</a>
                            </div>
                        </div>
                    </div>
                    <div class="project-wrapper2">
                        <div class="image-area">
                            <a href="/works/details" class="over-link"></a>
                            <img src="/assets/images/portfolio/10.webp" alt="" class="video-img">
                            <img src="/assets/images/portfolio/shape-top-left-w.svg" alt="" class="shape top-left-shape">
                            <img src="/assets/images/portfolio/shape-top-right-w.svg" width="120" alt="" class="shape top-right-shape">
                        </div>
                        <div class="slide-content">
                            <div class="product-intro">
                                <div class="top">
                                    <h3 class="title"><a href="/works/details">FinTrack Web App</a></h3>
                                    <p class="desc">Developed a financial tracking tool with smart analytics, helping
                                        users monitor expenses and manage budgets effectively.</p>
                                </div>
                                <div class="bottom">
                                    <ul>
                                        <li>
                    ...
                    <div class="delay-stats-rows">
                        <div class="delay-stats-row">
                            ...
                            <div class="delay-stats-bar-column">
                                ...
                                <div class="delay-stats-track">
                                    <div class="delay-stats-fill" role="progressbar" aria-label="Manual operations workload" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80" data-progress="80">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="delay-stats-row">
                            ...
                            <div class="delay-stats-bar-column">
                                ...
                                <div class="delay-stats-track">
                                    <div class="delay-stats-fill" role="progressbar" aria-label="Competitor growth pace" aria-valuemin="0" aria-valuemax="100" aria-valuenow="65" data-progress="65">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="delay-stats-row">
                            ...
                            <div class="delay-stats-bar-column">
                                ...
                                <div class="delay-stats-track">
                                    <div class="delay-stats-fill" role="progressbar" aria-label="Automation opportunities" aria-valuemin="0" aria-valuemax="100" aria-valuenow="70" data-progress="70">
                                    </div>
                                </div>
                            </div>
                        </div>

                    ...
                    <div class="col-lg-7">
                        <div class="blog-single-wrap">
                            <div class="image effectFade fadeZoom">
                                <img loading="lazy" width="777" height="548" src="/assets/images/blog/blog-1.jpg" alt="Image">
                            </div>
                            <div class="meta-list">
                                <div class="meta-item">
                                    <i class="icon icon-user-solid"></i>
                                    <a href="#" class="link ">Lewis Jones</a>
                                </div>
                                <div class="meta-item">
                                    <i class="icon icon-clock-solid"></i>
                                    <a href="#" class="link ">December 23, 2022</a>
                                </div>
                                <div class="meta-item">
                            ...
                            <p class="text-body-2 mb--0">
                                Sed vitae nulla eu velit fringilla hendrerit. Fusce luctus rhoncus blandit.
                                Nulla vel varius felis. Integer felis
                                urna, auctor hendrerit ante vitae, scelerisque bibendum quam. Proin libero leo,
                                pulvinar nec iaculis ac, sodales nec
                                tellus. Sed ut suscipit erat. Integer aliquam erat eget hendrerit ultricies. In
                                pharetra eu ante consequat
                                tincidunt. Curabitur vulputate ligula risus, ac auctor magna vulputate sit amet.
                                Sed finibus neque neque, euismod
                                porta felis vehicula at. Donec a sem id augue sagittis tincidunt non sit amet
                                risus.
                                <br>
                                <br>
                            ...
                            <div class="blockquote-wrap">
                                <h2 class="h5 fw-medium text-white">“ A little universe of inspiration — where
                                    passion meets professionalism and creativity
                                    knows no bounds. Exceptional service, stunning products that made me go
                                    'wow' at first glance, and prices that
                                    make you smile! ”
                                </h2>
                            ...
                            <p class="text-body-2">
                                ...
                                <br>
                                <br>
                                Vestibulum aliquet pulvinar neque sed ullamcorper. Ut vitae fringilla ex. Nam id
                                dui dignissim, maximus ligula id,
                                tempus metus. Sed commodo dui vitae dui pulvinar, eu dignissim turpis luctus.
                                Mauris consectetur leo est, non
                                finibus tellus posuere quis. Integer mollis felis a tristique facilisis. Nam
                                convallis est id iaculis mattis.
                            </p>
                            <div class="entry-footer">
                                <div class="tags-links">
                                    <h2 class="h6 text-body-1">Tags:</h2>
                                    <div class="list-tags">
                                        <a href="#" class="tags-item fw-semibold">Stakeholder</a>
                                        <a href="#" class="tags-item fw-semibold">Value model</a>
                                        <a href="#" class="tags-item fw-semibold">Data readiness</a>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center gap-12">
                                    <h2 class="h6 text-body-1">Share:</h2>
                                    <div class="tf-social justify-content-center">
                                        <a href="https://x.com/" target="_blank" class="social-item">
                            ...
                            <div class="comment-wrap">
                                <h2 class="h4 heading fw-semibold">Comments</h2>
                                <div class="author">
                                    <div class="image">
                                    ...
                                    <div class="content">
                                        <div class="info">
                                            <h2 class="h6 name fw-semibold text-body-1">
                                                <a class="link1" href="#">Davies</a>
                                            </h2>
                                            <p class="time text-body-3 text-white-64">July 8, 2025 at 7:35 am
                                            </p>
                                        </div>
                                        <a href="#post-comment" class="reply link1">Reply<i
                                                class="icon icon-arrow-top-right"></i></a>
                                        <p class="desc">“ Sed vitae velit erat. Pellentesque lobortis felis vel
                                            mi congue, in
                                            sollicitudin orci tincidunt. Praesent turpis justo, posuere eget
                                            justo sit
                            ...
                            <div class="post-comment" id="post-comment">
                                <h2 class="h4 heading fw-semibold">Post a Comments</h2>
                                <p class="text text-body-1">Your email address will not be published. Required
                                    fields are marked *</p>
                                <form class="form-cta style-2">
                                    <div class="form-content">
                                        <fieldset class="">
                                            <label class="fw-semibold text-body-3 mb-12">Your Name</label>
                                            <input class="" type="text" placeholder="Enter your full name" required>
                                        </fieldset>
                                        <fieldset class="">
                                            <label class="fw-semibold text-body-3 mb-12">Your Email</label>
                                            <input class="" type="email" placeholder="Enter your email" required>
                                        </fieldset>
                                        <fieldset class="">
                                            <label class="fw-semibold text-body-3 mb-12">Messenger</label>
                                            <textarea name="text" class="rounded-0"></textarea>
                                        </fieldset>
                                    </div>
                                    <div class="form-action">
                                        <button type="submit" class="wpr-btn btn-primary w-100">Submit Message</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="blog-sidebar m-lg-0">
                            <div class="sidebar-item effectFade fadeUp no-div">
                                ...
                                <form class="form-search">
                                    <fieldset class="text">
                                        <input type="text" placeholder="Search" class="" name="search" tabindex="0" value="" required="">
                                    </fieldset>
                                    <button type="submit" class="link1 text-white">
                            ...
                            <div class="sidebar-item effectFade fadeUp no-div">
                                ...
                                <div class="list-relatest-post">
                                    <div class="relatest-post-item">
                                        ...
                                        <div class="content">
                                            <h2 class="h6 title text-body-1">
                                                <a href="/blog/single" class="link1">
                            ...
                            <div class="sidebar-item effectFade fadeUp no-div">
                                ...
                                <div class="sidebar-categories">
                                    <div class="item">
                                        <a href="#" class="text-body-1 link1">Developer</a>
                                        <span class="text-body-3 text-white-64">(4)</span>
                                    </div>
                                    <div class="item">
                                        <a href="#" class="text-body-1 link1">Programmer</a>
                                        <span class="text-body-3 text-white-64">(2)</span>
                                    </div>
                                    <div class="item">
                                        <a href="#" class="text-body-1 link1">Web Design</a>
